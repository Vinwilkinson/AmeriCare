...
export default function TopSection() {
    return (
        <>
            ...
            <div className="dark:bg-darkBg dark:text-white bg-white pt-[10rem] pb-[4rem] grid-bg">
                <InViewWrapper animation={fadeIn} className="sm:px-[10rem] px-4 pb-[2rem] text-center flex flex-col items-center">
                    <div className="flex flex-col items-center">
                        <h1
                            ...
                            Events for <span className="px-4 rounded-[5rem] border dark:border-white/10 border-primary/25 dark:bg-white/10 bg-primary/10 hover:-translate-y-2 hover:dark:bg-white/15 hover:bg-primary/25 smooth">Every Stage</span> of <span className="px-4 rounded-[5rem] border dark:border-white/10 border-primary/25 dark:bg-white/10 bg-primary/10 hover:-translate-y-2 hover:dark:bg-white/15 hover:bg-primary/25 smooth">Caregiving</span>
                        </h1>
                        <span className="flex items-center flex-col">
                            <span>
                                Support groups, workshops, family activities, and our monthly parent webinar - October 2026 through January 2027.
                            </span>
                        </span>
                    </div>
                </InViewWrapper>
