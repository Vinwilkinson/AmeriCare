...
export default function PolicyPage() {
    return (
        <div className='max-2xl:pt-32 pt-24 sm:mt-14 py-8 dark:text-white sm:px-[5vw] px-4 flex flex-col gap-6'>
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="CollectionOfInformation">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="UseAndProcessingOfCollectedInformation">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="DisclosureOfInformation">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="RetentionOfInformation">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="PrivacyOfChildren">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="DoNotTrackSignals">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="EmailMarketing">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="LinksToOtherResources">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="InformationSecurity">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="DataBreach">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="ChangesAndAmendments">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="AcceptanceOfThisPolicy">
            ...
            <div className="flex flex-col gap-4 scroll-mt-32" id="ContactingUs">
