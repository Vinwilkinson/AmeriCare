    ...
    return (
        <InViewWrapper animation={prop.isOdd ? cardIn : cardInAlt} className="h-[20rem] relative grid place-items-center overflow-hidden rounded-lg group">
            <>
                ...
                />
                <div className="absolute sm:-bottom-6 bottom-3 group-hover:bottom-3 origin-bottom-right delay-75 smooth group-hover:rotate-0 origin-left bg-white/50 backdrop-blur-lg w-[calc(100%-1.5rem)] p-3 px-5 flex flex-col rounded-md">
