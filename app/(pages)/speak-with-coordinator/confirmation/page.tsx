        ...
        <div>
            ...
            <div className="relative z-10 pt-28 pb-20 sm:px-[8vw] px-6 dark:bg-darkBg">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl sm:text-5xl font-bold mb-4 text-white">Callback requested</h1>
                    <p className="text-lg text-white/70 mb-10">A care coordinator will contact you within one business day. We look forward to speaking with you.</p>
